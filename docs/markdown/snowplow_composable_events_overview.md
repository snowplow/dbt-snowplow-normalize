{% docs __snowplow_composable_events__ %}

{% raw %}

# Snowplow Composable Events Package

Welcome to the model documentation site for the Snowplow Composable Events dbt package. The package provides 2 macros and a python script that is used to generate your models; these models provide a table per event type that you specify, and can also produce a thin table of the decomposed events and a user table, for use within downstream ETL tools. 
...
The snowplow-decomposable-events package is Copyright 2022 Snowplow Analytics Ltd.
