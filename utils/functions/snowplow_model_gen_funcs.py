...
JSON Config file structure:
{
    ...
    "users": <optional - if not provided will not generate users model>{
        ...
        "user_contexts" : <required - array: array of strings of iglu:com. type url(s) for the context/entities to add to your users table as columns>
}"""
