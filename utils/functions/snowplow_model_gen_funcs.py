...
def parse_args(args: list):
    parser = argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter, description = 'Produce dbt model files for decomposing your Snowplow events table into 1 table per event')
...
JSON Config file structure:
{
    "config":{
        ...
        "models_folder": <optional - string: folder under models/ to place the models, default snowplow_decomposed_events>
    },
    "events":[
        {
